...
while not rospy.is_shutdown():
  ...
  #m.mesh_resource = "package://knowrob_cad_models/models/food-drinks/Coke-Bottle.dae";
  #m.scale = Vector3(0.0254,0.0254,0.0254)
  
  m.mesh_resource = "package://pr2_pouring_experiments/models/mondamin-pancake-mix.dae";
