...
// TODO(Georg): get rid of this ros dependency
#include <ros/ros.h>
...
namespace fccl
{
  namespace solvers
  {
    ...
    WDLSSolver::WDLSSolver(unsigned int num_constraints,
    ...
    void WDLSSolver::reinitialise(const unsigned int num_constraints,
     ...
     */
    bool WDLSSolver::solve(const Eigen::MatrixXd &A,
